...
function getLocalTrucks(req, res, next) {
	...
	db.any('SELECT c.truck_id, c.latitude, c.longitude, c.broadcasting, t.twitter_handle,' +
		't.url, t.name, t.phone, t.rating FROM (SELECT truckevents.truck_id, truckevents.latitude, truckevents.longitude FROM truckevents WHERE earth_box(ll_to_earth($1, $2),' +
